...
import 'package:new_todo_app/view/screens/login-screen.dart';
import 'package:new_todo_app/view/screens/todo_screen.dart';
    ...
    return MaterialApp(
      ...
      home: BlocListener<AuthCubit, AuthState>(
        ...
        listener: (context, state) {
          // عند تغيير المستخدم حمّل الـ todos الخاصة به
